...
<main class="relative flex justify-center items-center gap-8 bg-transparent max-w-[90rem] mx-auto px-4 xs:px-0 sm:px-6 md:px-8 lg:px-0 h-full lg:max-h-[calc(100vh-48px)] overflow-hidden">
    <slot></slot>
</main>
