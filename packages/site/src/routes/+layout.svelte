...
<main class="relative flex justify-between bg-transparent h-full max-w-[90rem] mx-auto px-4 xs:px-0 sm:px-6 md:px-8 lg:px-14">
    <slot></slot>
</main>

<footer class="flex justify-between px-3 md:px-6 items-center text-white w-full h-12 bg-gray-800">
