...
<main class="relative flex items-center justify-center gap-8 bg-transparent max-w-[90rem] mx-auto px-4 xs:px-0 sm:px-6 md:px-8 lg:px-0 h-full lg:max-h-[calc(100vh-48px)]">
    <slot></slot>
</main>

<footer class="fixed bottom-0 flex justify-between px-3 md:px-6 items-center text-white w-full h-12 bg-gray-800">
