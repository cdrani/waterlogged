    ...
    <section class="flex relative flex-col items-center w-full gap-8 h-full">
        <div class="flex flex-col justify-evenly gap-6 w-full h-full xl:w-1/2">
            ...
            <div class="flex justify-between md:justify-center xl:justify-between gap-2 md:gap-4 xl:gap-6 w-full h-8 md:h-10 lg:h-12">
                <button class="inline-flex items-center gap-1.5 md:gap-3 rounded-3xl w-28 md:w-32 lg:w-48 bg-green-800 text-[1rem] xl:text-2xl text-white font-semibold">
                ...
                <button class="inline-flex items-center gap-1.5 md:gap-3 rounded-3xl w-28 md:w-32 lg:w-48 bg-orange-600 text-[1rem] xl:text-2xl text-white font-semibold">
                ...
                <button disabled class="inline-flex items-center gap-1.5 md:gap-3 rounded-3xl w-28 md:w-32 lg:w-48 bg-blue-400 disabled:bg-gray-800 text-[1rem] xl:text-2xl text-white font-semibold">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-8 md:w-10 lg:w-12" viewBox="0 0 1200 1200"><path fill="white" stroke="white" d="M600 0C268.629 0 0 268.629 0 600s268.629 600 600 600s600-268.629 600-600S931.371 0 600 0M289.966 323.877h620.068v405.835H289.966zm76.904 73.975v257.959h466.26V397.852zM212.256 766.626h775.488v68.628l-39.404 40.869H251.66l-39.404-40.869zm315.82 22.485v62.183h143.848v-62.183z"/></svg>
                    Desktop
                </button>
            </div>
        </div>
