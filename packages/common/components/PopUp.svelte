...
>
    ...
    >
        <div class="border-white border-2 absolute z-[100] inset-0 left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex flex-col w-[248px] xs:w-11/12 lg:w-1/3 mx-auto h-[62dvh] md:h-[320px] lg:min-h-[360px]  bg-cyan-500 rounded-md">
