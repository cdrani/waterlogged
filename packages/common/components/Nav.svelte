...
<nav class="flex justify-end px-4">
    <ul class="flex justify-between items-center gap-x-1 p-1 pr-0">
        <li class="w-5 h-5">
            ...
            <li class="w-5 h-5">
                <button name="graph" on:click={updateView} class="w-5 h-5">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        <path class="{isRecords ? 'fill-gray-800' : 'fill-cyan-800'}" d="M4 9h4v2H4z" />
                        <path class="{isRecords ? 'fill-gray-800' : 'fill-cyan-800'}" d="M16 2h-1V0H5v2H3v1.25L2.4 4H1v1.75L0 7v9h12l4-5zM2 5h8v2H2zm9 10H1V8h10zm1-8h-1V4H4V3h8zm2-2.5l-1 1.25V2H6V1h8z" />
                    </svg>
                </button>
            </li>
        {/if}
