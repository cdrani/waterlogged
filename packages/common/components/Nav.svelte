...
<nav class="relative bg-cyan-200 flex w-full px-4 py-2 xs:py-1 lg:rounded-t-md">
    ...
    <div class="flex w-full justify-end">
        <ul class="relative flex justify-between items-center gap-x-4 xs:p-2 xs:pr-0">
            <li class="w-8 h-8">
                <button name="default" on:click={updateView} class="w-8 h-8">
            ...
            <li class="w-8 h-8 block lg:hidden mt-1.5">
                <button name="graph" on:click={updateView} class="w-8 h-8">
            ...
            <li class="w-8 h-8">
                <button name="settings" on:click={updateView} class="w-8 h-8">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
