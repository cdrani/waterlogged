...
{#if $settings}
    <section class="flex relative left-0 flex-col mx-auto w-full h-full overflow-y-auto bg-cyan-200">
        <form name="settings" class="relative flex flex-col gap-3 p-4 xs:p-6 pt-0 xs:pt-2 w-full mx-auto">
